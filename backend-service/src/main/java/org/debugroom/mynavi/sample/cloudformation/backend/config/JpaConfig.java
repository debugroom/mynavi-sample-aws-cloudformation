...
@EnableJpaRepositories(
        basePackages = "org.debugroom.mynavi.sample.cloudformation.backend.domain.repository.jpa"
)
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(
                "org.debugroom.mynavi.sample.cloudformation.backend.domain.model.jpa.entity");
